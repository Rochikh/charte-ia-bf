/* Charte IA Bruxelles Formation — Données
   Charte V2 + FAQ rédigée par un expert IA / pédagogie
   ============================================================ */
...
window.CHARTER = {
  ...
  engagements: [
    ...
    },
    {
      ...
      examples: {
        ok: [
          "Résumer un rapport public avec Copilot M365",
    ...
    },
    {
      ...
      slogan: "Tout faire avec l'IA est aussi absurde que rien.",
      pillars: [
      ...
      examples: {
        ok: [
          "Synthétiser 30 pages d'évaluations en 10 minutes",
...
/* ============================================================
   FAQ — 8 catégories, ~50 questions
   Réponses rédigées par un expert IA + pédagogie BF
   ============================================================ */
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "**Non pas avec votre adresse @bruxellesformation** sauf indication contraire de BF-TICE. Ces outils ne sont pas couverts par un contrat BF. Utilisez Copilot M365 pour le travail. Si vous souhaitez explorer un autre outil, faites-le sur un compte personnel et avec des données publiques uniquement."
      },
      {
      ...
      },
      {
        ...
        a: "Oui, **à condition de n'y faire entrer aucune donnée BF non publique**. Si le besoin est récurrent ou critique, signalez-le à BF-TICE : un outil interne peut être ajouté au catalogue. Ne contournez jamais une limite par convenance."
      },
      {
        q: "Que faire si je ne suis pas certain qu'une donnée est sensible ou confidentielle ?",
        a: "**Règle d'or : dans le doute, on ne met pas.** Anonymisez (remplacez les noms, adresses, identifiants), ou retirez l'information le temps de demander conseil à votre responsable ou à BF-TICE. Une fuite est toujours plus coûteuse qu'une question."
      },
      {
    ...
    items: [
      {
        ...
        a: "Trois points d'entrée :\n• **BF-TICE** — votre interlocuteur principal pour les questions d'outils, de sécurité, de prompts.\n• **Magellan** — section IA : ressources, FAQ, guides.\n• **Vos pairs** — la communauté interne d'utilisateur·rice·s IA partage ses pratiques."
      },
      {
